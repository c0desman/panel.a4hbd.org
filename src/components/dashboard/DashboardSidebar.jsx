...
const menuItems = [
  ...
  },
  {
    ...
    icon: Layers,
    submenu: [
      { label: "Home", icon: PanelTop, path: "/dashboard/page-content/home" },
      ...
      { label: "Our Works/Projects Page", icon: PanelTop, path: "/dashboard/page-content/our-works" },
      { label: "Our Stories", icon: PanelTop, path: "/dashboard/page-content/our-stories" },
      { label: "Contact Us", icon: PanelTop, path: "/dashboard/page-content/contact" },
      { label: "Collaboration Message", icon: PanelTop, path: "/dashboard/page-content/collaboration" },
    ],
  },
  {
    label: "Logout",
